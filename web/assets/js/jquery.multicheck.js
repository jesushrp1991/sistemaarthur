    ...
    MultiCheck.prototype.init = function() {
      ...
      this.$select.children('option').each(function() {
        ...
        if ($option.is(':selected')){
          checkbox = "<label" + label_class + ">\n  <input type=\"checkbox\" value=\"" + ($option.val()) + "\" checked data-on-color=\"primary\" data-off-color=\"danger\" class=\"switch\"/> " + ($option.text()) + "\n</label>";
        } else {
          checkbox = "<label" + label_class + ">\n  <input type=\"checkbox\" value=\"" + ($option.val()) + "\" data-on-color=\"primary\" data-off-color=\"danger\" class=\"switch\"/> " + ($option.text()) + "\n</label>";
        }
